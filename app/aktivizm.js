...
const Aktivizm = () => {
  ...
  return (
    <FlatList
          ...
          {filtrelerAcik && (
            <>
              ...
              <View style={{
                ...
                {[
                  "Hayvan Hakları", "İklim ve Ekoloji", "İşçi Hakları",
                  "Kadın Hakları", "LGBTİ+ Etkinlikleri", "Mülteci Hakları"
                ].map(tur => (
                  <TouchableOpacity
                    key={tur}
                    onPress={() => {
      ...
      ListEmptyComponent={
        !loading && filteredEtkinlik.length === 0 ? (
